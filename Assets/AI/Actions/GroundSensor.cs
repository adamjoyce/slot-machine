...
public class GroundSensor : VisualSensor
{
    ...
    protected override bool TestVisibility(RAINAspect aAspect, float aSqrRange)
    {
        ...
        RaycastHit2D myRaycastHit = Physics2D.Linecast(AI.Body.transform.position + new Vector3(direction * sizeX, 0.0f,0.0f), AI.Body.transform.position + new Vector3(direction * sizeX, -sizeY, 0.0f));
